...
IJK_EXTERN NSString *const IJKMPMoviePlayerPCMNotification;
IJK_EXTERN NSString *const IJKMPMoviePlayerPCMKey;

//蓝牙音乐第一次切换时激活失败
IJK_EXTERN NSString *const IJKMPMoviePlayerPlaybackStateDidChangeActiveErrorNotification;
